...
void *PinnedMemoryPool::get_from_bin(int bin_idx) {
  ...
  logging::MPIPrintStreamDebug() << "Allocating new memory of size " << bin_size << "\n";
...
EventPool::EventPool(int num_events, int expansion):
