...
struct HostShadow<Tensor<DataType, LocaleMPI, CUDAAllocator>>
{
  ...
  using ShadowTensorType = Tensor<DataType, LocaleMPI, CUDAHostPooledAllocator>;
...
template <typename DataType>
struct HostShadow<Tensor<DataType, LocaleMPI, CUDAHostPooledAllocator>>
{
  using TensorType = Tensor<DataType, LocaleMPI, CUDAHostPooledAllocator>;
