...
public:
  TensorMPICUDAShuffler(TensorType const& src_tensor,
    ...
    : m_src_local_shape(src_tensor.get_local_shape()),
      ...
      m_send_counts(nullptr),
      m_recv_counts(nullptr),
      m_send_displs_h(nullptr),
      m_recv_displs_h(nullptr),
      m_send_displs_d(nullptr),
      m_recv_displs_d(nullptr),
      m_src_buf(src_buf),
      m_dst_buf(dst_buf),
...
protected:
                        ...
                        h2::gpu::DeviceStream stream)
  {
    ...
    {
      h2::gpu::mem_copy((void*) send_buf_h, (void*) send_buf, send_buffer_size);
    }

    MPI_Alltoallv(send_buf_h,
                  get_send_counts(is_forward),
                  get_send_displs_h(is_forward),
                  util::get_mpi_data_type<DataType>(),
                  recv_buf_h,
    ...
    {
      h2::gpu::mem_copy((void*) recv_buf, (void*) recv_buf_h, recv_buffer_size);
    }
