...
public:
   ...
   */
  StreamManager(size_t num_internal_streams, h2::gpu::DeviceStream main_stream);
...
public:
  ...
  static void destroy_activation_descriptor(ActivationDescriptor_t const& desc);
...
public:
  ...
  using ActivationDescriptor_t = typename VendorBackend::ActivationDescriptor_t;
...
public:
  ...
  virtual void convolution_bwd_filter(double alpha,
                                      TensorDescriptor_t const& in_desc,
                                      void const* in_data,
                                      TensorDescriptor_t const& dy_desc,
                                      void const* dy_data,
