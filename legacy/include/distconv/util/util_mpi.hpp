...
template <> inline
MPI_Datatype get_mpi_data_type<char>() {
  return MPI_CHAR;
}

template <> inline
MPI_Datatype get_mpi_data_type<unsigned char>() {
  return MPI_UNSIGNED_CHAR;
}

template <> inline
MPI_Datatype get_mpi_data_type<short>() {
  return MPI_SHORT;
}

template <> inline
MPI_Datatype get_mpi_data_type<unsigned short>() {
...
template <> inline
MPI_Datatype get_mpi_data_type<unsigned int>() {
  return MPI_UNSIGNED;
}

template <> inline
MPI_Datatype get_mpi_data_type<long>() {
  return MPI_LONG;
}

template <> inline
MPI_Datatype get_mpi_data_type<unsigned long>() {
