...
// Testing Remove
static_assert(EqV<Remove<TList, int>, TL<float, double, int, float, double>>(),
              "Remove first entry.");
static_assert(EqV<Remove<TList, float>, TL<int, double, int, float, double>>(),
              "Remove second entry.");
static_assert(EqV<Remove<TList, double>, TL<int, float, int, float, double>>(),
              "Remove third entry.");
