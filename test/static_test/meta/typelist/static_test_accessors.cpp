...
static_assert(EqV<Car<TL<float>>, float>(), "Car of length one list");
static_assert(EqV<Car<TL<int, float>>, int>(), "Car of length two list");
static_assert(!EqV<Car<TL<int, float>>, float>(), "Car of length two list");

// Testing Head
static_assert(EqV<Head<Empty>, Nil>(), "Head of empty list is empty.");
static_assert(EqV<Head<TL<float>>, float>(), "Head of length one list");
static_assert(EqV<Head<TL<int, float>>, int>(), "Head of length two list");
static_assert(!EqV<Head<TL<int, float>>, float>(), "Head of length two list");

// Testing Cdr
static_assert(EqV<Cdr<Empty>, Empty>(), "Cdr of empty list is empty.");
static_assert(EqV<Cdr<TL<float>>, Empty>(), "Cdr of length one list");
static_assert(EqV<Cdr<TL<int, float>>, TL<float>>(), "Cdr of length two list");
static_assert(!EqV<Cdr<TL<int, float>>, float>(), "Car of length two list");
...
static_assert(EqV<Cdaar<TList>, TL<TList1, int, long>>(), "Cdr of car of car");
static_assert(EqV<Cdadr<TList>, TL<TList1, int, long>>(), "Cdr of car of cdr");
static_assert(EqV<Cddar<TList>, TL<TList1, int, long>>(), "Cdr of cdr of car");
static_assert(EqV<Cdddr<TList>, TL<long, long long>>(), "Cdr of cdr of cdr");
...
static_assert(EqV<Cdaaar<TList>, TL<short, int>>(), "Cdr of car of car of car");
static_assert(EqV<Cdaadr<TList>, TL<short, int>>(), "Cdr of car of car of cdr");
static_assert(EqV<Cdadar<TList>, TL<short, int>>(), "Cdr of car of cdr of car");
static_assert(EqV<Cdaddr<TList>, TL<short, int>>(), "Cdr of car of cdr of cdr");
static_assert(EqV<Cddaar<TList>, TL<int, long>>(), "Cdr of cdr of car of car");
