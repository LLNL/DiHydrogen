...
// Two
static_assert(EqV<tlist::Append<TL<int>, TL<float>>, TL<int, float>>(),
              "tlist::Append two nonempty lists");
static_assert(EqV<tlist::Append<TList1, TList2>, ResultTList12>(),
              "tlist::Append two nonempty lists");

// Three lists
static_assert(
  EqV<tlist::Append<tlist::Empty, tlist::Empty, tlist::Empty>, tlist::Empty>(),
  "tlist::Append empty, empty, and empty.");
static_assert(EqV<tlist::Append<TList1, TList2, TList3>, ResultTList123>(),
