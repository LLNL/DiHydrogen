...
static_assert(LengthV<TypeList<int>>() == 1UL,
              "Length of TypeList<int> is one.");
static_assert(LengthV<TypeList<int, float>>() == 2UL,
              "Length of TypeList<int, float> is two.");
static_assert(LengthV<TypeList<int, float, char>>() == 3UL,
              "Length of TypeList<int, float, char> is three.");

// Not sure why I did this... Must have been bored. Oh well...
static_assert(LengthV<Append<
              Empty,
