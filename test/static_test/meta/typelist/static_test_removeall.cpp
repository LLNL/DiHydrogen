...
static_assert(EqV<
              RemoveAll<TList, int>,
              TL<float, double, float, double>>(),
              "Remove first entry.");
static_assert(EqV<
              RemoveAll<TList, float>,
              TL<int, double, int, double>>(),
              "Remove second entry.");
static_assert(EqV<
              RemoveAll<TList, double>,
              TL<int, float, int, float>>(),
              "Remove third entry.");
static_assert(EqV<RemoveAll<TList, bool>, TList>(),
