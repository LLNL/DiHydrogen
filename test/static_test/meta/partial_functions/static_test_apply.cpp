...
static_assert(
    EqV<Apply<F<int, int, int>, tlist::Empty>, F<int, int, int>>(),
    "Apply returns input when no placeholders present.");

static_assert(
    EqV<Apply<F<_1, _2, _3>, TL<int>>, F<int, _1, _2>>(),
    "Replacing the first argument.");
static_assert(
    EqV<Apply<F<_1, _2, _3>, TL<int, char>>, F<int, char, _1>>(),
...
static_assert(
    EqV<Apply<F<_1, _3, _2>, TL<int>>, F<int, _2, _1>>(),
    "Replacing the first argument.");
static_assert(
    EqV<Apply<F<_1, _3, _2>, TL<int, char>>, F<int, _1, char>>(),
    "Replacing the first two arguments.");
static_assert(
...
static_assert(
    EqV<Apply<F<_2, _1, _3>, TL<int>>, F<_1, int, _2>>(),
    "Replacing the first argument.");
static_assert(
    EqV<Apply<F<_2, _1, _3>, TL<int, char>>, F<char, int, _1>>(),
    "Replacing the first two arguments.");
static_assert(
...
static_assert(
    EqV<Apply<F<_2, _3, _1>, TL<int>>, F<_1, _2, int>>(),
    "Replacing the first argument.");
static_assert(
    EqV<Apply<F<_2, _3, _1>, TL<int, char>>, F<char, _1, int>>(),
    "Replacing the first two arguments.");
static_assert(
...
static_assert(
    EqV<Apply<F<_3, _1, _2>, TL<int>>, F<_2, int, _1>>(),
    "Replacing the last argument only.");
static_assert(
    EqV<Apply<F<_3, _1, _2>, TL<int, char>>, F<_1, int, char>>(),
...
static_assert(
    EqV<Apply<F<_3, _2, _1>, TL<int>>, F<_2, _1, int>>(),
    "Replacing the last argument only.");
static_assert(
    EqV<Apply<F<_3, _2, _1>, TL<int, char>>, F<_1, char, int>>(),
    "Replacing the last two arguments.");
static_assert(
