...
static_assert(EqV<Apply<F<int, int, int>, tlist::Empty>,
              F<int, int, int>>(),
...
static_assert(EqV<Apply<F<_1,_2,_3>, TL<int, char, bool>>,
              F<int, char, bool>>(),
...
static_assert(EqV<Apply<F<_1,_3,_2>, TL<int, char>>, F<int, _1, char>>(),
              "Replacing the first two arguments.");
static_assert(EqV<Apply<F<_1,_3,_2>, TL<int, bool, char>>,
              F<int, char, bool>>(),
              "Replacing all three arguments.");
...
static_assert(EqV<Apply<F<_2,_1,_3>, TL<int, char>>, F<char, int, _1>>(),
              "Replacing the first two arguments.");
static_assert(EqV<Apply<F<_2,_1,_3>, TL<int, char, bool>>,
              F<char, int, bool>>(),
              "Replacing all three arguments.");
...
static_assert(EqV<Apply<F<_2,_3,_1>, TL<int, char>>, F<char, _1, int>>(),
              "Replacing the first two arguments.");
static_assert(EqV<Apply<F<_2,_3,_1>, TL<int, char, bool>>,
              F<char, bool, int>>(),
              "Replacing all three arguments.");
...
static_assert(EqV<Apply<F<_3,_1,_2>, TL<int, char, bool>>,
              F<bool, int, char>>(),
...
static_assert(EqV<Apply<F<_3,_2,_1>, TL<int, char>>, F<_1, char, int>>(),
              "Replacing the last two arguments.");
static_assert(EqV<Apply<F<_3,_2,_1>, TL<int, char, bool>>,
              F<bool, char, int>>(),
              "Replacing all arguments backwards.");
