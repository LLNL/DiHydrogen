    ...
    AllTensorDevs)
{
    ...
    SECTION("To DistMatrix(MC, MR)")
    {
        ...
        constexpr auto dist_types =
            h2::DistributionTypeTuple{h2::internal::to_h2_dist(coldist),
                                      h2::internal::to_h2_dist(rowdist)};

        SECTION("Correct communicator and dist type")
        {
            auto const proc_grid =
                h2::ProcessorGrid{g.VCComm(), grid_shape_cmaj};
        ...
        SECTION("Correct dist types, 1d col comm instead of 2d")
        {
            ...
            auto const proc_grid_bad =
                h2::ProcessorGrid{g.VCComm(), grid_shape_1dc};
            h2::DistTensor<DataType> tensor_bad{
                device, tensor_shape, dim_types, proc_grid_bad, dist_types};
            TensorType& tensor_bad_ref = tensor_bad;
            CHECK_THROWS(as_h_matrix(tensor_bad_ref, g, coldist, rowdist));
        ...
        SECTION("Correct dist types, 1d row comm instead of 2d")
        {
            ...
            auto const proc_grid_bad =
                h2::ProcessorGrid{g.VCComm(), grid_shape_1dr};
            h2::DistTensor<DataType> tensor_bad{
                device, tensor_shape, dim_types, proc_grid_bad, dist_types};
            TensorType& tensor_bad_ref = tensor_bad;
            CHECK_THROWS(as_h_matrix(tensor_bad_ref, g, coldist, rowdist));
    ...
    SECTION("To DistMatrix(MR, MC)")
    {
        ...
        SECTION("Correct communicator and dist type")
        {
            ...
            auto const proc_grid =
                h2::ProcessorGrid{g.VRComm(), grid_shape_rmaj};
        ...
        SECTION("Correct dist types, 1d col comm instead of 2d")
        {
            ...
            auto const proc_grid_bad =
                h2::ProcessorGrid{g.VRComm(), grid_shape_1dc};
            h2::DistTensor<DataType> tensor_bad{
                device, tensor_shape, dim_types, proc_grid_bad, dist_types};
            TensorType& tensor_bad_ref = tensor_bad;
            CHECK_THROWS(as_h_matrix(tensor_bad_ref, g, coldist, rowdist));
        ...
        SECTION("Correct dist types, 1d row comm instead of 2d")
        {
            ...
            auto const proc_grid_bad =
                h2::ProcessorGrid{g.VRComm(), grid_shape_1dr};
            h2::DistTensor<DataType> tensor_bad{
                device, tensor_shape, dim_types, proc_grid_bad, dist_types};
            TensorType& tensor_bad_ref = tensor_bad;
            CHECK_THROWS(as_h_matrix(tensor_bad_ref, g, coldist, rowdist));
